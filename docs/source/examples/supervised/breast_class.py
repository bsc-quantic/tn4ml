...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="read arguments for training MPS on data distribution"
    )
    ...
    parser.add_argument(
        "-bond_dims", dest="bond_dims", type=int, nargs="+", default=[2, 4, 8, 16, 32]
    )
    ...
    for bond_dim in args.bond_dims:
        ...
        sensitivity = recall_score(
            true, predicted
        )  # default is recall for positive class
